...
import com.jeff.jframework.tools.display.DisplayUtils;
...
public final class ConvertUtils {
    ...
    public static int dp2px(final float dpValue) {
        final float scale = DisplayUtils.getSystemDensity();
    ...
    public static int sp2px(final float spValue) {
        final float fontScale = DisplayUtils.getSystemScaledDensity();
