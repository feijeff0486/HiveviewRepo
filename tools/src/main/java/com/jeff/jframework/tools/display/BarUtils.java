...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (ContextUtils.getContext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = ContextUtils.getContext().getSystemService("statusbar");
    ...
    private static String getResNameById(int id) {
        try {
            return ContextUtils.getResources().getResourceEntryName(id);
