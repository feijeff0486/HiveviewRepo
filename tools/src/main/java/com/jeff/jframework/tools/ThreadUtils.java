...
public final class ThreadUtils {
    ...
    private static final ConcurrentHashMap<Task, ScheduledExecutorService> TASK_SCHEDULED = new ConcurrentHashMap<>();

    @IntDef({PoolType.TYPE_SINGLE, PoolType.TYPE_CACHED, PoolType.TYPE_IO, PoolType.TYPE_CPU})
    @Retention(RetentionPolicy.SOURCE)
    private @interface PoolType{
        byte TYPE_SINGLE = -1;
        byte TYPE_CACHED = -2;
        byte TYPE_IO = -4;
        byte TYPE_CPU = -8;
    ...
    public static ExecutorService getSinglePool() {
        return getPoolByTypeAndPriority(PoolType.TYPE_SINGLE);
    }
    ...
    public static ExecutorService getSinglePool(@IntRange(from = 1, to = 10) final int priority) {
        return getPoolByTypeAndPriority(PoolType.TYPE_SINGLE, priority);
    }
    ...
    public static ExecutorService getCachedPool() {
        return getPoolByTypeAndPriority(PoolType.TYPE_CACHED);
    }
    ...
    public static ExecutorService getCachedPool(@IntRange(from = 1, to = 10) final int priority) {
        return getPoolByTypeAndPriority(PoolType.TYPE_CACHED, priority);
    }
    ...
    public static ExecutorService getIoPool() {
        return getPoolByTypeAndPriority(PoolType.TYPE_IO);
    }
    ...
    public static ExecutorService getIoPool(@IntRange(from = 1, to = 10) final int priority) {
        return getPoolByTypeAndPriority(PoolType.TYPE_IO, priority);
    }
    ...
    public static ExecutorService getCpuPool() {
        return getPoolByTypeAndPriority(PoolType.TYPE_CPU);
    }
    ...
    public static ExecutorService getCpuPool(@IntRange(from = 1, to = 10) final int priority) {
        return getPoolByTypeAndPriority(PoolType.TYPE_CPU, priority);
    }
    ...
    public static <T> void executeBySingle(final Task<T> task) {
        execute(getPoolByTypeAndPriority(PoolType.TYPE_SINGLE), task);
    }
    ...
    public static <T> void executeBySingle(final Task<T> task,
                                           @IntRange(from = 1, to = 10) final int priority) {
        execute(getPoolByTypeAndPriority(PoolType.TYPE_SINGLE, priority), task);
    }
    ...
    public static <T> void executeBySingleWithDelay(final Task<T> task,
                                                    final long delay,
                                                    final TimeUnit unit) {
        executeWithDelay(getPoolByTypeAndPriority(PoolType.TYPE_SINGLE), task, delay, unit);
    }
    ...
    public static <T> void executeBySingleWithDelay(final Task<T> task,
                                                    ...
                                                    final TimeUnit unit,
                                                    @IntRange(from = 1, to = 10) final int priority) {
        executeWithDelay(getPoolByTypeAndPriority(PoolType.TYPE_SINGLE, priority), task, delay, unit);
    }
    ...
    public static <T> void executeBySingleAtFixRate(final Task<T> task,
                                                    final long period,
                                                    final TimeUnit unit) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_SINGLE), task, 0, period, unit);
    }
    ...
    public static <T> void executeBySingleAtFixRate(final Task<T> task,
                                                    ...
                                                    final TimeUnit unit,
                                                    @IntRange(from = 1, to = 10) final int priority) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_SINGLE, priority), task, 0, period, unit);
    }
    ...
    public static <T> void executeBySingleAtFixRate(final Task<T> task,
                                                    ...
                                                    final long period,
                                                    final TimeUnit unit) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_SINGLE), task, initialDelay, period, unit);
    }
    ...
    public static <T> void executeBySingleAtFixRate(final Task<T> task,
                                                    ...
                                                    @IntRange(from = 1, to = 10) final int priority) {
        executeAtFixedRate(
                getPoolByTypeAndPriority(PoolType.TYPE_SINGLE, priority), task, initialDelay, period, unit
        );
    }
    ...
    public static <T> void executeByCached(final Task<T> task) {
        execute(getPoolByTypeAndPriority(PoolType.TYPE_CACHED), task);
    }
    ...
    public static <T> void executeByCached(final Task<T> task,
                                           @IntRange(from = 1, to = 10) final int priority) {
        execute(getPoolByTypeAndPriority(PoolType.TYPE_CACHED, priority), task);
    }
    ...
    public static <T> void executeByCachedWithDelay(final Task<T> task,
                                                    final long delay,
                                                    final TimeUnit unit) {
        executeWithDelay(getPoolByTypeAndPriority(PoolType.TYPE_CACHED), task, delay, unit);
    }
    ...
    public static <T> void executeByCachedWithDelay(final Task<T> task,
                                                    ...
                                                    final TimeUnit unit,
                                                    @IntRange(from = 1, to = 10) final int priority) {
        executeWithDelay(getPoolByTypeAndPriority(PoolType.TYPE_CACHED, priority), task, delay, unit);
    }
    ...
    public static <T> void executeByCachedAtFixRate(final Task<T> task,
                                                    final long period,
                                                    final TimeUnit unit) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_CACHED), task, 0, period, unit);
    }
    ...
    public static <T> void executeByCachedAtFixRate(final Task<T> task,
                                                    ...
                                                    final TimeUnit unit,
                                                    @IntRange(from = 1, to = 10) final int priority) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_CACHED, priority), task, 0, period, unit);
    }
    ...
    public static <T> void executeByCachedAtFixRate(final Task<T> task,
                                                    ...
                                                    final long period,
                                                    final TimeUnit unit) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_CACHED), task, initialDelay, period, unit);
    }
    ...
    public static <T> void executeByCachedAtFixRate(final Task<T> task,
                                                    ...
                                                    @IntRange(from = 1, to = 10) final int priority) {
        executeAtFixedRate(
                getPoolByTypeAndPriority(PoolType.TYPE_CACHED, priority), task, initialDelay, period, unit
        );
    }
    ...
    public static <T> void executeByIo(final Task<T> task) {
        execute(getPoolByTypeAndPriority(PoolType.TYPE_IO), task);
    }
    ...
    public static <T> void executeByIo(final Task<T> task,
                                       @IntRange(from = 1, to = 10) final int priority) {
        execute(getPoolByTypeAndPriority(PoolType.TYPE_IO, priority), task);
    }
    ...
    public static <T> void executeByIoWithDelay(final Task<T> task,
                                                final long delay,
                                                final TimeUnit unit) {
        executeWithDelay(getPoolByTypeAndPriority(PoolType.TYPE_IO), task, delay, unit);
    }
    ...
    public static <T> void executeByIoWithDelay(final Task<T> task,
                                                ...
                                                final TimeUnit unit,
                                                @IntRange(from = 1, to = 10) final int priority) {
        executeWithDelay(getPoolByTypeAndPriority(PoolType.TYPE_IO, priority), task, delay, unit);
    }
    ...
    public static <T> void executeByIoAtFixRate(final Task<T> task,
                                                final long period,
                                                final TimeUnit unit) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_IO), task, 0, period, unit);
    }
    ...
    public static <T> void executeByIoAtFixRate(final Task<T> task,
                                                ...
                                                final TimeUnit unit,
                                                @IntRange(from = 1, to = 10) final int priority) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_IO, priority), task, 0, period, unit);
    }
    ...
    public static <T> void executeByIoAtFixRate(final Task<T> task,
                                                ...
                                                final long period,
                                                final TimeUnit unit) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_IO), task, initialDelay, period, unit);
    }
    ...
    public static <T> void executeByIoAtFixRate(final Task<T> task,
                                                ...
                                                @IntRange(from = 1, to = 10) final int priority) {
        executeAtFixedRate(
                getPoolByTypeAndPriority(PoolType.TYPE_IO, priority), task, initialDelay, period, unit
        );
    }
    ...
    public static <T> void executeByCpu(final Task<T> task) {
        execute(getPoolByTypeAndPriority(PoolType.TYPE_CPU), task);
    }
    ...
    public static <T> void executeByCpu(final Task<T> task,
                                        @IntRange(from = 1, to = 10) final int priority) {
        execute(getPoolByTypeAndPriority(PoolType.TYPE_CPU, priority), task);
    }
    ...
    public static <T> void executeByCpuWithDelay(final Task<T> task,
                                                 final long delay,
                                                 final TimeUnit unit) {
        executeWithDelay(getPoolByTypeAndPriority(PoolType.TYPE_CPU), task, delay, unit);
    }
    ...
    public static <T> void executeByCpuWithDelay(final Task<T> task,
                                                 ...
                                                 final TimeUnit unit,
                                                 @IntRange(from = 1, to = 10) final int priority) {
        executeWithDelay(getPoolByTypeAndPriority(PoolType.TYPE_CPU, priority), task, delay, unit);
    }
    ...
    public static <T> void executeByCpuAtFixRate(final Task<T> task,
                                                 final long period,
                                                 final TimeUnit unit) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_CPU), task, 0, period, unit);
    }
    ...
    public static <T> void executeByCpuAtFixRate(final Task<T> task,
                                                 ...
                                                 final TimeUnit unit,
                                                 @IntRange(from = 1, to = 10) final int priority) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_CPU, priority), task, 0, period, unit);
    }
    ...
    public static <T> void executeByCpuAtFixRate(final Task<T> task,
                                                 ...
                                                 final long period,
                                                 final TimeUnit unit) {
        executeAtFixedRate(getPoolByTypeAndPriority(PoolType.TYPE_CPU), task, initialDelay, period, unit);
    }
    ...
    public static <T> void executeByCpuAtFixRate(final Task<T> task,
                                                 ...
                                                 @IntRange(from = 1, to = 10) final int priority) {
        executeAtFixedRate(
                getPoolByTypeAndPriority(PoolType.TYPE_CPU, priority), task, initialDelay, period, unit
        );
    }
    ...
    private synchronized static ScheduledExecutorService getScheduledByTask(final Task task) {
        ...
        if (scheduled == null) {
            CustomThreadFactory factory = createThreadFactory("scheduled", Thread.MAX_PRIORITY);
    ...
    public static CustomThreadFactory createThreadFactory(String prefix, int priority){
        return new CustomThreadFactory(prefix,priority);
    }

    private static ExecutorService createPoolByTypeAndPriority(final int type, final int priority) {
        switch (type) {
            case PoolType.TYPE_SINGLE:
                return Executors.newSingleThreadExecutor(
                        createThreadFactory("single", priority)
                );
            case PoolType.TYPE_CACHED:
                return Executors.newCachedThreadPool(
                        createThreadFactory("cached", priority)
                );
            case PoolType.TYPE_IO:
                return new ThreadPoolExecutor(2 * CPU_COUNT + 1,
                        2 * CPU_COUNT + 1,
                        30, TimeUnit.SECONDS,
                        new LinkedBlockingQueue<Runnable>(128),
                        createThreadFactory("io", priority)
                );
            case PoolType.TYPE_CPU:
                return new ThreadPoolExecutor(CPU_COUNT + 1,
                        2 * CPU_COUNT + 1,
                        30, TimeUnit.SECONDS,
                        new LinkedBlockingQueue<Runnable>(128),
                        createThreadFactory("cpu", priority)
                );
            default:
                return Executors.newFixedThreadPool(type,
                        createThreadFactory("fixed(" + type + ")", priority)
                );
        }
    }
    ...
    public abstract static class Task<T> implements Runnable {
        ...
        @IntDef({State.NEW, State.COMPLETING, State.CANCELLED, State.EXCEPTIONAL})
        @Retention(RetentionPolicy.SOURCE)
        @interface State {
            int NEW = 0;
            int COMPLETING = 1;
        ...
        @State
        private volatile int state = State.NEW;
    ...
    private static final class CustomThreadFactory extends AtomicLong
        ...
        CustomThreadFactory(String prefix, int priority) {
